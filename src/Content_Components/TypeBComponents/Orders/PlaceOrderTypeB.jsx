...
`;
  ...
  const FailureMarketCloseJson = {
    status: "false",
    message:
      "RMS:1141241105101:NSE,EQUITY,22,ACC,INTRADAY,,EQ,SATYA,B,1,I,22,ACC,INTRADAY,89.44995,FUND LIMIT INSUFFICIENT,AVAILABLE FUND=0,ADDITIONAL REQUIRED FUND=572.36,CALCULATED MARGIN FOR ORDER=572.36",
    errorcode: "RS-0111",
    data: null,
  };
  ...
  const requestParameter = [
    ...
    },
    {
      ...
      Type: "string",
      Description:
        "It is optional to apply to an order to identify. The length of the tag should be less than 20 characters.",
    },
  ];
      ...
      <div className="flex flex-col gap-2">
        ...
        <dl class="pl-4">
          ...
          <div class="flex">
            ...
            <dd>
              A token-based authentication header. The format is token
              api_key:jwtToken. Content-Type: For this request, it is set to{" "}
              <span className="mstockNavFont">application/json</span>, which is
              used for submiting form data through body
            </dd>
          </div>
          <div class="flex">
