  ...
  const LoginParameters = [
    {
      ...
      Type: "string",
      Description:
        "The username of the user attempting to log in. (Example: SATYA)",
    },
    {
      Field: "password",
      Type: "string",
      Description:
        "The password associated with the username. (Example: Macm@123)",
    },
  ];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        <p>
          ...
          their username and password. Successful authentication will send the
          OTP to users registered mobile no that can be used for subsequent
          requests.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p>
          The body of the request must be URL-encoded and include the following
          parameters:
        </p>
        ...
        <div>
          <ul className="list-outside list-disc px-6 flex flex-col gap-6">
            ...
            <li>
              ...
              On successful login, the server returns a JSON object containing
              the authentication token and any relevant user information.
            </li>
            <NewJsonViewer data={SuccessResponseJson} />
            {/* Failure Version Json View repsonse */}
            <li>
              <span className="font-semibold">Failure (HTTP Status 400): </span>{" "}
              If the version is incorrect, the server will return an error
              message.
            </li>
            ...
            <li>
              <span className="font-semibold">Failure (HTTP Status 500): </span>{" "}
              If the login credentials are incorrect, the server will return an
              error message.
            </li>
