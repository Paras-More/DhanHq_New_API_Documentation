    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        <p>
          ...
          provided API key, request token, and checksum. The session token is
          essential for authenticating subsequent API requests
        </p>
      </div>
        ...
        <div>
          <ul className="list-outside list-disc px-6 flex flex-col gap-6">
            ...
            <li>
              ...
              If the request fails due to an invalid OTP passed, the server will
